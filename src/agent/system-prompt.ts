import { AgentContext, SurvivalTier } from './context.js';
import { readFileSync } from 'fs';
import { join } from 'path';

export async function generateSystemPrompt(context: AgentContext): Promise<string> {
...
function generateCoreIdentity(context: AgentContext): string {
...
function generateSurvivalContext(context: AgentContext): string {
...
function generateCapabilityDescription(context: AgentContext): string {
...
function generateSituationAnalysis(context: AgentContext): string {
...
function generateActionGuidance(context: AgentContext): string {
...
export function generateUserMessage(userInput: string, context: AgentContext): string {
