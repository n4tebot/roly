...
export class BalanceChecker {
    ...
    async getBalance(wallet) {
        ...
        try {
            tokenAccount = await getAssociatedTokenAddress(this.usdcMint, wallet.publicKey);
     ...
     */
    async hasMinimumSol(wallet, minLamports = 10_000) {
     ...
     */
    async getOrCreateTokenAccount(wallet) {
        try {
            const tokenAccount = await getAssociatedTokenAddress(this.usdcMint, wallet.publicKey);
            ...
            if (error instanceof TokenAccountNotFoundError) {
                ...
                return await getAssociatedTokenAddress(this.usdcMint, wallet.publicKey);
            }
            throw error;
        }
    }
     ...
     */
    async startBalanceMonitoring(wallet, callback, intervalMs = 30000) {
